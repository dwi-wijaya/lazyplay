    ...
    <div class="flex justify-center items-center min-h-screen">
        <div class="sm:card bg-none p-5 sm:w-[35rem] w-[23.5rem] !rounded-3xl gap-4 sm:!p-7">
            ...
            <div class="flex gap-2 justify-center mt-4">
                <button class="!border-neutral-300 card group hover:!bg-neutral-100 !bg-neutral-50 flex justify-center items-center w-full"
                    @click="signInWithProvider('github')">
                    <img class="w-6 group-hover:-rotate-12 duration-300 transition-all" src="@assets/logos/github.svg" alt="GitHub">
                </button>
                <button class="!border-neutral-300 card group group/card hover:!bg-neutral-100 flex !bg-neutral-50 justify-center items-center w-full"
                ...
                <button class="!border-neutral-300 card group group/card hover:!bg-neutral-100 flex !bg-neutral-50 justify-center items-center w-full"
                    ...
                    <img class="w-6 group-hover:-rotate-12 duration-300 transition-all" src="@assets/logos/facebook.svg" alt="Twitter">
                </button>
                <button class="!border-neutral-300 card group group/card hover:!bg-neutral-100 flex !bg-neutral-50 justify-center items-center w-full"
