<template>
    <h3 class="text-lg mt-0 flex gap-2 font-semibold items-center"><i class="text-primary fad fa-fire"></i>Top Pick</h3>
            ...
            <li v-for="(song, index) in songs" :key="song.id"
                ...
                <div class="flex gap-2 items-center">
                    ...
                    <div class="w-20 relative">
                        ...
                        <div
                            class="hidden absolute rounded-xl text-white w-full base-transition gap-2 top-0 left-0 h-full bg-black opacity-75  group-hover/song:flex justify-center items-center">
                    ...
                    <div class="flex flex-col">
                        ...
                        <p class="text-neutral-400 text-sm line-clamp-1"><i class="fad fa-user-music text-xs mr-2"></i>{{
                            song.artist }}</p>
                    </div>
                </div>
                <div class="flex mr-4">
